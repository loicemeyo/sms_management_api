...
const doesPhoneNumberExist = require('../middleware/validators/doesPhoneNumberExist')
const { handleSuccess, handleFailure, handleSuccessResult } = require('../middleware/helpers/responsesHelper')
const validateContactPayload = require('../middleware/validators/validateContactPayload')
...
class ContactsController {
  ...
  static async deleteContact(req, res) {
    try {
      ...
      return handleSuccess(res, HttpStatus.OK, 'contact deleted successfully')
    } catch(error) {
      return handleFailure(res, HttpStatus.INTERNAL_SERVER_ERROR, error)
    }
  }
